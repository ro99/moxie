...
| Next | [Task 0031](docs/tasks/0031-m3-battery-closure.md)'s full publication battery; shared importer continuations; then M3 item 3's quantized-expert half and common graph consumers. Nothing routed executes a quantized weight. |
