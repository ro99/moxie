...
| Next | [Task 0031](docs/tasks/0031-m3-battery-closure.md): full publication battery found five unexpected survivors; all five targeted regressions now catch them, full rerun pending. [Task 0034](docs/tasks/0034-m3-gptq-integer-import.md): GPTQ/AutoRound import implemented, review pending. [Task 0035](docs/tasks/0035-m3-quantized-grouped-experts.md): synthetic quantized grouped experts execute on all three GPUs; artifact binding, mapped GPU execution and cancellation pass; review and closure gates remain. |
| Continuation | [M3 recovery direction](docs/handovers/2026-09-16-m3-recovery-direction.md), tasks 0031/0032; earlier handovers remain historical evidence. |
