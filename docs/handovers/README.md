...
implements the remaining M1.4 shared-service/diagnostic-CLI slice and is corrected
at `5990f2a` and `7a08adf` after independent review. Final re-review and owner
acceptance remain pending. M1.4 remains active. Model integration
