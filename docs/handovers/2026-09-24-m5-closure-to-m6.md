...
| M6.5 | Automatic plan selection from measured topology/shape costs; fixed-plan mode | Not started | — | Builds on M5.5's `compare-plans`; needs a compute-cost term, which also gates slice 6's device transition (0094) |
