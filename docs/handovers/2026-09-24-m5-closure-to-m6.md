...
| M6.4 | Joint prefill/decode placement and phase transitions; no host-cache or prepared-layout growth across many turns | **Active** | luna, [0088](../tasks/0088-m6-no-growth-across-many-turns.md) | 24-turn growth check over the reused bucket plans |
