...
implemented, corrected after two rounds of independent review that found
**sixteen** issues — all reproduced, all fixed, none disputed — and awaiting
...
Gates: 812 host tests + doctests, 832
