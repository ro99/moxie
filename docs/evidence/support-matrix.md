...
| `G-HOST-TEST` | `cargo test --workspace --locked` | host | passed, 485 unit/integration tests + 6 doctests |
...
| `G-GPU-ALL` | `cargo xtask-cuda test-gpu` | device | passed, 24 cases, both architectures qualified |
...
Counts are from 2026-09-09 after [task 0008](../tasks/0008-m1-measured-host-capacity.md); the M0
