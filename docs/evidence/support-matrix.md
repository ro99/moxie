...
Owner acceptance is recorded in task 0012: **M1.3 complete; M1.4 active**. The next bounded assignment
is appendable paged state bound to task 0004; no additional preparatory M1.3 task is needed.
