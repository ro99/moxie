...
| `G-HOST-TEST` | `cargo test --workspace --locked` | host | passed, 506 unit/integration tests + 6 doctests |
...
| `G-GPU-ALL` | `cargo xtask-cuda test-gpu` | device | passed, 27 cases, both architectures qualified |
