...
implemented, corrected after three rounds of independent review that found
**twenty** issues — all reproduced, all fixed, none disputed — and awaiting
owner acceptance: one production weight-residency owner, connected to bounded
