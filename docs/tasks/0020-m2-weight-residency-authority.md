...
Status: **proposed. Contract written and committed before implementation**, per
the working rule that produced tasks 0013–0019. See
...
*Empty until the work is done. Passed, failed and skipped are reported
separately; an unmeasured gate is reported as unmeasured and never as passed.*
